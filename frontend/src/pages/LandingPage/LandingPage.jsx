    ...
    return (
        <div className="min-h-screen px-4 sm:px-8 md:px-12 lg:px-20 bg-[#f9f6e8]">
            <div className="header h-[10vh] sm:h-[12vh] md:h-[14vh]  flex flex-row justify-between">
                <Logo className="transion-transform duration-300 hover:scale-110"></Logo>
                <div className="accountButton flex flex-row justify-center items-center space-x-4">
                    <Link to="/login">
                        <Button1 className="w-24 sm:w-28 transition-all duration-300 hover:scale-105 hover:shadow-lg">Login</Button1>
                    </Link>

                    <Button1 className="w-24 sm:w-28 transition-all duration-300 hover:scale-105 hover:shadow-lg">Sign up</Button1>
                </div>
            </div>
            <div className="wrapper mt-2 md:mt-5">
                <div data-aos="fade-up" className="banner min-h-[calc(100vh-10vh)] flex flex-col-reverse md:flex-row items-center pb-10 md:pb-0">
                    <div className="text flex flex-col w-full md:w-1/2 text-center md:text-left mt-8 md:mt-0">
                        <div style={{ filter: "drop-shadow(5px 5px 5px rgba(0,0,0,0.5))" }} className="transition-all duration-300 hover:scale-105 boldText flex text-4xl sm:text-5xl md:text-6xl lg:text-[4.8rem] font-bold font-poppins leading-tight md:justify-start">
                            Every meal tells
                        </div>
                        <div style={{ filter: "drop-shadow(5px 5px 5px rgba(0,0,0,0.5))" }} className="transition-all duration-300 hover:scale-105 boldText text-4xl sm:text-5xl md:text-6xl lg:text-[4.8rem] font-bold font-poppins flex flex-row items-center md:justify-start group">
                            a memory
                            <img style={{ filter: "drop-shadow(5px 5px 10px rgba(0,0,0,0.5))" }} className="h-16 sm:h-20 md:h-28 lg:h-[180px] ml-2 sm:ml-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110" src="./smallPic.webp" alt="" />
                        </div>
                        <p className="smallText w-full mt-4 text-base sm:text-lg md:text-xl lg:text-2xl font-inter text-justify transition-all duration-300 hover:scale-[1.02] cursor-pointer">
                    ...
                    <div className="bannerImg w-full md:w-1/2 flex items-center justify-center">
                        <img style={{ filter: "drop-shadow(10px 10px 20px rgba(0,0,0,0.5))" }} className="w-5/6 transition-transform duration-500 hover:scale-105 hover:rotate-2" src="./LandingPagePic1.png" alt="" />
                    </div>
                </div>
            </div>
            <div
            ...
            <div data-aos="fade-up" className="sampleReview min-h-auto md:min-h-screen flex flex-col md:flex-row items-center pt-10 md:pt-20 pb-10 md:pb-0">
                <div className="bannerImg w-full md:w-1/2 flex items-center justify-center mb-8 md:mb-0 ">
                    <img style={{ filter: "drop-shadow(10px 10px 20px rgba(0,0,0,0.5))" }} className="w-5/6 transition-transform duration-500 hover:scale-105 hover:-rotate-2" src="./LandingPagePic2.png" alt="" />
                </div>
                <div className="text flex flex-col w-full md:w-1/2 text-center md:text-left">
                    ...
                    <p className="smallText w-full mt-4 text-base sm:text-lg md:text-xl lg:text-2xl text-justify font-inter text-2xl transition-all duration-300 hover:scale-[1.02] cursor-pointer">
                        Cooking is more than just preparing food — it is a way of keeping memories alive. Every recipe carries a story, whether it is a dish passed down through generations or something new you discovered yesterday. With our platform, you can safely store, organize, and revisit all your favorite recipes anytime. No matter where you are, your kitchen memories will always be within reach, ready to inspire your next meal. This space is designed to celebrate tradition, creativity, and the joy of sharing food with the people you love.
                    </p>
                </div>
            </div>
            <div className="footer mt-16 md:mt-20 border-t-[1px] border-t-[#9ca3af] h-[auto] py-6 flex flex-col sm:flex-row items-center justify-between text-center sm:text-left">
                <div className="flex flex-row space-x-4 mb-4 sm:mb-0">
                    <div className="font-poppins text-[#9ca3af]  text-sm sm:text-base cursor-pointer transition-colors duration-300 hover:text-gray-600 hover:underline">About</div>
                    <div className="font-poppins text-[#9ca3af]  text-sm sm:text-base cursor-pointer transition-colors duration-300 hover:text-gray-600 hover:underline">Term</div>
                </div>
                <div className="font-poppins text-[#9ca3af] transition-colors duration-300 hover:text-gray-600">Granny's Secret ©</div>
            </div>
        </div>
    )
}
