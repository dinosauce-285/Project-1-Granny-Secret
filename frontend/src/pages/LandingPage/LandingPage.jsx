        ...
        <div className="min-h-screen px-4 sm:px-8 md:px-12 lg:px-20 bg-[#f9f6e8]">
            <div className="header h-[10vh] sm:h-[12vh] md:h-[14vh]  flex flex-row justify-between">
                ...
                <div className="accountButton flex flex-row justify-center items-center space-x-4">
                    ...
                    <Link to="/signup">
                        <Button1 className="w-20 sm:w-24 md:w-28 px-3 py-2 text-sm sm:text-base transition-all duration-300 hover:scale-105 hover:shadow-lg border border-black hover:bg-black hover:text-white">Sign up</Button1>
                    </Link>
                </div>
            </div>
            <div className="wrapper mt-2 md:mt-5">
                <div data-aos="fade-up" className="banner min-h-[60vh] md:min-h-[calc(100vh-10vh)] flex flex-col-reverse md:flex-row items-center pb-10 md:pb-0">
                    <div className="text flex flex-col w-full md:w-1/2 text-center md:text-left mt-8 md:mt-0">
                        ...
                        <div style={{ filter: "drop-shadow(5px 5px 5px rgba(0,0,0,0.5))" }} className="transition-all duration-300 hover:scale-105 boldText text-4xl sm:text-5xl md:text-6xl lg:text-[4.8rem] font-bold font-poppins flex flex-row flex-wrap items-center md:justify-start group">
                            a memory
                            <img style={{ filter: "drop-shadow(5px 5px 10px rgba(0,0,0,0.5))" }} className="h-12 sm:h-16 md:h-28 lg:h-[180px] ml-2 mt-2 md:mt-0 sm:ml-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110" src="./smallPic.webp" alt="" />
                        </div>
            ...
            <div data-aos="fade-up" className="sampleReview min-h-auto md:min-h-[80vh] flex flex-col md:flex-row items-center pt-10 md:pt-20 pb-10 md:pb-0">
