  ...
  return (
    <div className="min-h-screen flex bg-page">
      ...
      >
        ...
        <ButtonPrimary className="hover:bg-primary-hover text-white py-2.5 sm:py-3 bg-primary mt-4 sm:mt-6 text-sm sm:text-base w-full transition-all duration-300 hover:scale-105 hover:shadow-lg border-none">
          Sign In
        </ButtonPrimary>
