            ...
            <MainLayout>
                <div className=" w-[95%] shadow-2xl font-inter mx-auto bg-white rounded-2xl py-4 px-4 flex flex-col space-y-10 justify-between items-start border border-dashed border-gray-300">
                    ...
                    <div className="recipeName w-full space-y-2" >
                        ...
                        <input id="title" name="title" className="py-2 px-2 w-full border border-gray-300 outline-none rounded-md hover:border-olive transition-all duration-300" type="text" placeholder="e.g., Delicious Spaghetti Bolognese" />
                        ...
                        <div className="options flex flex-row justify-between  w-full">
                            <div className="flex flex-col space-y-2 w-[24%]">
                                ...
                                <input placeholder="e.g., 15 " className="border border-gray-300 w-full rounded-md py-2 px-2 outline-none hover:border-olive" type="number" id="prepTime" name="prepTime" />
                            </div>
                            <div className="flex flex-col space-y-2 w-[24%]">
                                <label htmlFor="cookTime" className="font-medium text-2xl">Cook Time (mins)</label>
                                <input placeholder="e.g., 30" className="border border-gray-300 w-full rounded-md py-2 px-2 outline-none hover:border-olive" type="number" id="cookTime" name="cookTime" />
                            </div>
                            <div className="flex flex-col space-y-2 w-[24%]">
                                <label htmlFor="servings" className="font-medium text-2xl">Serving</label>
                                <input placeholder="e.g., 4" className="border border-gray-300  w-full rounded-md py-2 px-2 outline-none hover:border-olive" type="number" id="servings" name="servings" />
                            </div>
                            <div className="flex flex-col space-y-2 w-[24%]">
                                <label htmlFor="spiciness" className="font-medium text-2xl">Spiciness (0-5)</label>
                                <input id="spiciness" name="spiciness" type="number" min={0} max={5} className="border border-gray-300  w-full rounded-md py-2 px-2  outline-none hover:border-olive" />
                            </div>
                        </div>
                        ...
                        <div className="flex flex-row w-full gap-6">
                            <div className="w-1/2">
                                ...
                                <select id="difficulty" name="difficulty" className="appearance-none border border-gray-300  w-full rounded-md py-2 px-2  outline-none hover:border-olive">
                                    <option>Easy</option>
                            ...
                            <div className="w-1/2">
                                ...
                                <select id="category" name="category" className="appearance-none border border-gray-300  w-full rounded-md py-2 px-2  outline-none hover:border-olive">
                        ...
                        <div className="button" >
                            <ButtonPrimary type="button" className="w-40 sm:w-44 md:w-48 px-3 py-5 text-md sm:text-lg text-white  font-semibold bg-primary transition-all duration-300 hover:bg-primary-hover hover:scale-105 hover:shadow-lg border border-none">Create Recipe</ButtonPrimary>
                        </div>
                    </div>
                </div>
            </MainLayout>
